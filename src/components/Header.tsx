    ...
    <header>
      ...
      <div id="top-header" className="bg-[#15161D] py-2">
        <div className="container mx-auto px-4">
          <div className="flex flex-col gap-3 text-center text-xs text-white/90 sm:flex-row sm:items-center sm:justify-between sm:text-sm">
            <ul className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
              <li>
                <a href="#" className="flex items-center gap-1 hover:text-[#f59e0b] transition-colors">
            ...
            <div className="w-full lg:w-1/2">
              <div className="header-search">
                <form className="flex flex-col gap-3 sm:flex-row">
                  <select className="input-select w-full rounded-full border border-[#E4E7ED] bg-white px-4 py-2.5 text-sm font-medium text-[#2B2D42] outline-none sm:w-auto">
                    <option value="0">All Categories</option>
                    <option value="1">Category 01</option>
                    <option value="1">Category 02</option>
                  </select>
                  <input
                    className="input w-full rounded-full border border-[#E4E7ED] px-4 py-2.5 text-sm text-[#2B2D42] outline-none sm:flex-1"
                    placeholder="Search here"
                    type="text"
                  />
                  <button className="search-btn w-full rounded-full bg-[#2563eb] px-6 py-2.5 text-sm font-semibold uppercase text-white transition-colors hover:bg-[#1d4ed8] sm:w-auto">
                    Search
                  </button>
                </form>
              </div>
