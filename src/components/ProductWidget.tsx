...
const ProductWidget = ({ product }: ProductWidgetProps) => {
  return (
    <div className="product-widget relative mb-[30px] shadow-[0px_0px_0px_1px_#E4E7ED] transition-all duration-200 hover:shadow-[0px_0px_6px_0px_#E4E7ED]">
      ...
      <div className="product-body pl-[75px] pr-[15px] py-[15px]">
        ...
        <h3 className="product-name text-sm mb-[5px]">
          <Link to={`/product/${product.id}`} className="font-medium text-[#2B2D42] hover:text-[#D10024] transition-colors duration-200">
            {product.name}
          </Link>
        </h3>
        <h4 className="product-price text-[#D10024] font-bold text-base">
